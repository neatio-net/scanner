defmodule Explorer.Chain.Supply.ProofOfAuthority do
  @moduledoc """
  Defines the supply API for calculating supply for NIO.

  NIO launched on Dec 15, 2017 with 252,460,800 coins with 20% reserved for
  ...
  See https://github.com/poanetwork/wiki/wiki/NIO-Token-Supply for more
  information.
  """
