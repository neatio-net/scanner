...
/*
 * Interface for requests to the multi-rate oracle (for EUR/NIO and ERC20)
...
interface MultiOracleRequestI {
    ...
    /**
     * @dev Timestamp of when the last update for the NIO rate occurred
     */
    function lastUpdate() external view returns (uint256);

    /**
     * @dev Number of EUR per NIO (rounded down!)
     */
    function ETH_EUR() external view returns (uint256); // solhint-disable func-name-mixedcase

    /**
     * @dev Number of EUR cent per NIO (rounded down!)
     */
    ...
    /**
     * @dev Emitted on rate update - using address(0) as tokenAddress for NIO updates
     */
...
contract CS3_1OnChainShop {
    ...
    // Buy assets. The number of assets is determined from the amount of NIO sent.
